...
public class PathConstant {
    ...
    public static String IMAGE_USER = "img/users/";
    public static String ADMIN_AVATAR = "img/admin/";
    ...
    public static String ADMIN_AVATAR_STATIC = PathConstant.STATIC + PathConstant.ADMIN_AVATAR;
