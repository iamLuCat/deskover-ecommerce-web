        ...
        function() {
            ...
            for (var l = document.querySelectorAll(".range-slider"), e = 0; e < l.length; e++) ! function(e) {
                var t = l[e].querySelector(".range-slider-ui"),
                    ...
                    k = JSON.parse(sessionStorage.getItem('ngStorage-filter')),
                    a = {
                        dataStartMin: parseInt(k===null?l[e].dataset.startMin:k.minPrice, 10),
                        dataStartMax: parseInt(k===null?l[e].dataset.startMax:k.maxPrice, 10),
                ...
                noUiSlider.create(t, {
                    ...
                    format: {
                        to: function(e) {
                            return formatNum.to(parseInt(e, 10))
                        },
                        from: function(e) {
                            return Number(e)
                        }
                    ...
                    console.log(k)
                    e = (e = e[t]).replace(/\D/g, "");
                    t ? n.value = formatNum.to(Math.round(e)) : r.value = formatNum.to(Math.round(e))
                }), r.addEventListener("change", function() {
                    t.noUiSlider.set([this.value, null])
                    angular.element(document.getElementById('shopCtrl')).scope().shop.sliderUpdate(t.noUiSlider.get(true));
                }), n.addEventListener("change", function() {
                    t.noUiSlider.set([null, this.value])
                    angular.element(document.getElementById('shopCtrl')).scope().shop.sliderUpdate(t.noUiSlider.get(true));
                }), document.addEventListener('DOMContentLoaded', function () {
                    t.noUiSlider.on("end", function() {
                        angular.element(document.getElementById('shopCtrl')).scope().shop.sliderUpdate(t.noUiSlider.get(true));
                })})
            }(e)
